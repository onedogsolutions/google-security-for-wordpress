...
export default function StatusBadge({ siteKey, secretKey }) {
  ...
  if (hasSite && hasSecret) {
    ...
    label = __('Incomplete Configuration', 'google-recaptcha-v3-for-woocommerce');
  ...
  return (
    <div className="flex items-center gap-x-2">
      ...
      <span className={`inline-flex items-center gap-x-1.5 rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${badgeClass}`}>
        <svg className={`h-1.5 w-1.5 ${dotClass} rounded-full`} viewBox="0 0 6 6" aria-hidden="true">
