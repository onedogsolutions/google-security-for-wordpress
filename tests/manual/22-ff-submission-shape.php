...
echo "  To settle that, add this to a mu-plugin, submit one form in a browser,\n";
echo "  then read the log and REMOVE IT AGAIN:\n\n";
...
echo "  '-' and no coverage gap in the log. Report both log lines verbatim.\n";
